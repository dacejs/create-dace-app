...
exports.help = function() {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/dacejs/dace/issues/new')}
  `;
};

exports.exampleHelp = function() {
  return `Example from https://github.com/dacejs/dace/tree/master/examples/ ${output.param(
    'example-path'
  )}`;
};
...
For example:
  ${chalk.cyan(program.name)} ${chalk.green('my-dace-app')}
...
exports.start = function(projectName) {
  ...
  ${chalk.green('https://github.com/dacejs/dace/issues')}
`;
};
